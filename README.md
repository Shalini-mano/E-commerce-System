...
Open `EcommerceApplication.java` in IntelliJ and click the green **Run** button. The app starts on port 9000.
...
- Production: `https://e-commerce-system-nbza.onrender.com`
...
| Resource                 | URL                                                               |
|--------------------------|-------------------------------------------------------------------|
| **Backend Deployed URL** | https://e-commerce-system-nbza.onrender.com                      |
| **Backend API**          | https://xxxx.onrender.com                                         |
| **Swagger Document URL** | https://e-commerce-system-nbza.onrender.com/swagger-ui/index.html |
